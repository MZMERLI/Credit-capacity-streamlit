...
# Loading icon/image
########################################################
image = Image.open("C:/Users/HP ELITEBOOK/Desktop/Nouveau dossier/images/pngwing.com.png")

########################################################
# Loading data, model and preprocessing
########################################################
# Data description of features:
description = pd.read_csv('C:/Users/HP ELITEBOOK/Desktop/Nouveau dossier/HomeCredit_columns_description.csv',
                                verbose=False,
                                encoding='ISO-8859-1',
                                )
...
@st.cache
def load_data ():
    data = pd.read_csv('C:/Users/HP ELITEBOOK/Desktop/Nouveau dossier/data_try.csv')
